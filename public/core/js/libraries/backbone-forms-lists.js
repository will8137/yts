define(['jquery', 'underscore', 'backbone', 'backboneForms'], function($, _, Backbone) {
  ...
  Form.editors.List = Form.editors.Base.extend({
    ...
    template: _.template('\
      <div class="form-list-items">\
        <div data-items></div>\
        <button class="button primary" type="button" data-action="add">Add</button>\
      </div>\
  ...
  Form.editors.List.Item = Form.editors.Base.extend({
    ...
    //STATICS
    template: _.template('\
      <div class="form-list-item clearfix">\
        <span data-editor></span>\
        <button class="button warning" type="button" data-action="remove">&times;</button>\
      </div>\
    ', null, Form.templateSettings),
